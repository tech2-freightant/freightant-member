    ...
    <Form form={form} layout="vertical" onFinish={formFinish}>
      <Row gutter={[16, 16]}>
        ...
        }
        {
          ...
          <Col span={12}>
            <Form.Item label="Place of Discharge" layout="vertical">
                  ...
                  columns={[
                      ...
                      render: (_: any, record: any, index: number) => (
                        <Space size="small">
                          ...
                          <Button
                            className="p-0"
                            type="link"
                            disabled={freightData[index]?.costHead?.length === 0}
                            onClick={() => setFreightData(deleteAtIndex(freightData, index))}
                          >
                            <DeleteOutlined />
                          </Button>
                        </Space>
                      ...
                      children: [
                        {
                          ...
                          render: (_: any, record: any, index: number) => (
                            <Select
                              className="w-100 text-wrap text-center"
                    ...
                    },
                    {
                      ...
                      render: (_: any, record: any, index: number) => (
                        <Input
                          placeholder="Rate"
                          disabled={!freightData[index].unit}
                          variant="outlined"
                          className="p-1 text-center"
                          value={freightData[index].rate}
                  ...
                  <CustomTable dataSource={polChargesData}
                    columns={[
                      ...
                      },
                      {
                        ...
                        key: "costHead",
                        width: "400px",
                        className: "text-wrap p-1 text-center",
                        render: (_: any, record: any, index: number) => (
                          <Select
                    ...
                    <Form.Item label={"Port of Loading [POL] charges"} layout="horizontal"> 
                      ...
                      <Space>
                        <Form.Item name={"polChargeLocal"} noStyle>
                          <Input disabled className="rounded-pill bg-shade text-primary1" variant="borderless" style={{ width: "190px" }} addonBefore={currencyCode} />
                        </Form.Item>
                      </Space>
                    </Form.Item>
                  </Col>
          ...
          <Col span={24}>
            <Card title="Shipping Line Details" styles={{ header: { borderBottom: 0 } }}>
              <Row gutter={[16, 16]}>
                ...
                <Col sm={24} md={12}>
                  <Form.Item
                    name={"noOfTransShipmentPorts"}
                    label={`Transshipment ${rfq?.modeOfShipment === strings.air ? "Airports" : "Ports" }`} layout="horizontal">
                    <Space className="border rounded p-2">
                      <Button onClick={() =>form.setFieldValue("noOfTransShipmentPorts",Math.max(noOfTransShipmentPorts - 1, 0) 
                          )
                        }
                        size="small"
                        type="primary"
                      ...
                      <span className="mx-3" style={{ textWrap: "nowrap" }}>
                        <Form.Item name={"noOfTransShipmentPorts"} noStyle>
                          <Input
                            type="number"
                        ...
                        {noOfTransShipmentPorts} {rfq?.modeOfShipment === strings.air ? "airports" : "ports"}
                      </span>
                      <Button
                        onClick={() =>form.setFieldValue("noOfTransShipmentPorts",Math.min(noOfTransShipmentPorts + 1, 15) 
                          )
                        }
                        size="small"
                        type="primary"
                ...
                <Col span={24} className="border rounded-2 border-primary2 p-2">
                  <div className="d-flex justify-content-between">
                    <h5 className="text-primary2">
                      Transshipment {rfq?.modeOfShipment === strings.air ? "Airports" : "Ports"}
                    </h5>
                      ...
                      <Space className="border rounded p-2">
                        ...
                        <Button
                          onClick={() =>
                            form.setFieldValue(
                              "transitTime",
                              Math.max(transitTime - 1, 0) // Prevents value from going below 0
                            )
                          }
                          size="small"
                          type="primary"
                        ...
                        <Button
                          onClick={() =>
                            form.setFieldValue(
                              "transitTime",
                              transitTime ? transitTime + 1 : 1 // Sets to 1 if undefined, otherwise increments
                            )
                          }
                          size="small"
                          type="primary"
                    ...
                    <Form.Item label={`SI Cut off Date & Time`} layout="horizontal">
                      <Space>
                        ...
                        <Form.Item rules={[{ required: true }]} name={["siCutOff", "time"]} >
                          <TimePicker format="HH" placeholder="Select Time" />
          ...
          <Card title="Terms & Conditions" styles={{ header: { borderBottom: 0 } }}>
            <Form.Item rules={[{ required: true }]} name={"termsCondition"}>
              <Input.TextArea
                ...
                className='rounded-2'
                autoSize={{ minRows: 3 }} // Allows for multi-line input
              />
            </Form.Item>
          </Card>
        </Col>
